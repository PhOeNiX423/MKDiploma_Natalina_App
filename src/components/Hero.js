  ...
  return (
    <section className="w-full bg-pinkaccent py-20 text-white text-center">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Link
          to="/catalog"
          className="inline-block px-6 py-3 text-pinkaccent font-bold bg-white text-pinkaccent rounded-full transition duration-300 hover:bg-white hover:text-pinksecondary"
        >
          Перейти в каталог →
        </Link>
      </div>
