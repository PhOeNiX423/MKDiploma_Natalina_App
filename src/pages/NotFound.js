 ...
 * NotFound.js
 * 
 * Компонент страницы 404 — отображается, если пользователь перешёл по несуществующему маршруту.
 * 
 * - Показывает логотип, код ошибки 404 и сообщение о том, что страница не найдена.
 * - Предлагает пользователю вернуться на главную страницу через ссылку.
 */
